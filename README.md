...
```bash
curl -fsSL -o /tmp/overleaf_install_script.sh https://git.serv.eserver.icu/ewbc/sharelatexfull/raw/branch/fix/refactor/scripts/overleaf_automated_install.sh && bash /tmp/overleaf_install_script.sh && rm /tmp/overleaf_install_script.sh
```
